...
const DARK = {
  bg:"#060608",card:"rgba(12,12,12,0.97)",cardBorder:"rgba(255,255,255,0.08)",
  nav:"rgba(5,5,5,0.97)",navBorder:"rgba(255,255,255,0.08)",
  text:"rgba(255,255,255,0.88)",textSub:"rgba(255,255,255,0.45)",textFaint:"rgba(255,255,255,0.25)",
  inputBg:"rgba(255,255,255,0.05)",inputBorder:"rgba(255,255,255,0.09)",inputText:"rgba(255,255,255,0.85)",
  pillOn:"rgba(255,255,255,0.15)",pillOnBdr:"rgba(255,255,255,0.5)",pillOff:"rgba(255,255,255,0.04)",pillOffBdr:"rgba(255,255,255,0.1)",
  pillOnTxt:"#fff",pillOffTxt:"rgba(255,255,255,0.4)",
  btnBg:"rgba(255,255,255,0.1)",btnBdr:"rgba(255,255,255,0.15)",btnTxt:"rgba(255,255,255,0.9)",
  outBox:"rgba(255,255,255,0.03)",outBdr:"rgba(255,255,255,0.07)",
  hlBg:"rgba(255,220,50,0.22)",hlTxt:"rgba(255,230,100,0.95)",
  codeBg:"rgba(255,255,255,0.08)",codeTxt:"rgba(180,220,255,0.9)",
  callBg:"rgba(255,200,50,0.06)",callBdr:"rgba(255,200,50,0.18)",callLeft:"rgba(255,200,50,0.6)",callTxt:"rgba(255,230,130,0.9)",
  remBg:"rgba(100,180,255,0.05)",remBdr:"rgba(100,180,255,0.15)",remLeft:"rgba(100,180,255,0.5)",remTxt:"rgba(150,210,255,0.9)",
  fmlBg:"rgba(255,255,255,0.04)",fmlBdr:"rgba(255,255,255,0.1)",fmlTxt:"rgba(200,240,200,0.9)",
  fcBg:"rgba(255,255,255,0.03)",fcBdr:"rgba(255,255,255,0.07)",fcQ:"rgba(255,255,255,0.25)",fcQTxt:"rgba(255,255,255,0.85)",
  fcA:"rgba(100,200,255,0.4)",fcATxt:"rgba(150,210,255,0.8)",
  divider:"rgba(255,255,255,0.06)",infoBg:"rgba(255,255,255,0.03)",infoBdr:"rgba(255,255,255,0.07)",infoTxt:"rgba(255,255,255,0.3)",
  notesBg:"rgba(255,220,50,0.04)",notesBdr:"rgba(255,220,50,0.1)",notesTxt:"rgba(255,220,100,0.5)",
  topperRow:"rgba(255,255,255,0.03)",topperBdr:"rgba(255,255,255,0.07)",topperTxt:"rgba(255,255,255,0.85)",
  topperSrc:"rgba(255,255,255,0.25)",topperArrow:"rgba(255,255,255,0.25)",
  ytCardBg:"rgba(255,255,255,0.03)",ytCardBdr:"rgba(255,255,255,0.07)",ytName:"rgba(255,255,255,0.9)",ytDesc:"rgba(255,255,255,0.45)",
  ytLink:"rgba(255,255,255,0.25)",ytBadge1Bg:"rgba(255,255,255,0.12)",ytBadge1Bdr:"rgba(255,255,255,0.25)",ytBadge1Txt:"#fff",
  ytBadgeXBdr:"rgba(255,255,255,0.1)",ytBadgeXTxt:"rgba(255,255,255,0.35)",
  spinTrack:"rgba(255,255,255,0.08)",spinHead:"rgba(255,255,255,0.7)",spinTxt:"rgba(255,255,255,0.35)",
  headerNum:"rgba(255,255,255,0.18)",headerTitle:"rgba(255,255,255,0.88)",headerBdr:"rgba(255,255,255,0.06)",
  badgeDot:"rgba(255,255,255,0.6)",badgeTxt:"rgba(255,255,255,0.35)",tagline:"rgba(255,255,255,0.28)",
  featurePill:"rgba(255,255,255,0.28)",featureBdr:"rgba(255,255,255,0.07)",featureBg:"rgba(255,255,255,0.02)",
  navIconOn:"rgba(255,255,255,0.95)",navIconOff:"rgba(255,255,255,0.28)",navLblOn:"rgba(255,255,255,0.9)",navLblOff:"rgba(255,255,255,0.25)",
  navBubbleOn:"rgba(255,255,255,0.08)",navBubbleBdrOn:"rgba(255,255,255,0.15)",
  eraseBtn:"rgba(255,255,255,0.35)",poweredBy:"rgba(255,255,255,0.1)",
};

const LIGHT = {
  bg:"#f5f5f7",card:"#ffffff",cardBorder:"#e0e0e5",nav:"#ffffff",navBorder:"#e0e0e5",
  text:"#111114",textSub:"#444450",textFaint:"#999",
  inputBg:"#f9f9fb",inputBorder:"#d0d0d8",inputText:"#111114",
  pillOn:"#111114",pillOnBdr:"#111114",pillOff:"#f0f0f4",pillOffBdr:"#d0d0d8",pillOnTxt:"#fff",pillOffTxt:"#555560",
  btnBg:"#111114",btnBdr:"#111114",btnTxt:"#fff",outBox:"#f9f9fb",outBdr:"#e0e0e5",
  hlBg:"rgba(255,200,0,0.18)",hlTxt:"#7a5500",codeBg:"#eef2ff",codeTxt:"#3040b0",
  callBg:"#fffbea",callBdr:"#f0d060",callLeft:"#d09000",callTxt:"#6a4d00",
  remBg:"#eef6ff",remBdr:"#90c0f0",remLeft:"#1a70c0",remTxt:"#0d3d70",
  fmlBg:"#f0fff4",fmlBdr:"#80d0a0",fmlTxt:"#0d5030",
  fcBg:"#f9f9fb",fcBdr:"#e0e0e5",fcQ:"#d09000",fcQTxt:"#111114",fcA:"#1a70c0",fcATxt:"#0d3d70",
  divider:"#e8e8ee",infoBg:"#f5f5f7",infoBdr:"#e0e0e5",infoTxt:"#777",
  notesBg:"#fffdf0",notesBdr:"#f0d060",notesTxt:"#7a5500",
  topperRow:"#f9f9fb",topperBdr:"#e0e0e5",topperTxt:"#111114",topperSrc:"#888",topperArrow:"#aaa",
  ytCardBg:"#f9f9fb",ytCardBdr:"#e0e0e5",ytName:"#111114",ytDesc:"#444450",ytLink:"#888",
  ytBadge1Bg:"#111114",ytBadge1Bdr:"#111114",ytBadge1Txt:"#fff",ytBadgeXBdr:"#d0d0d8",ytBadgeXTxt:"#555560",
  spinTrack:"#e0e0e5",spinHead:"#111114",spinTxt:"#888",
  headerNum:"#aaa",headerTitle:"#111114",headerBdr:"#e8e8ee",
  badgeDot:"#111114",badgeTxt:"#777",tagline:"#666",featurePill:"#555560",featureBdr:"#d8d8e0",featureBg:"#f5f5f7",
  navIconOn:"#111114",navIconOff:"#bbb",navLblOn:"#111114",navLblOff:"#bbb",
  navBubbleOn:"rgba(0,0,0,0.07)",navBubbleBdrOn:"rgba(0,0,0,0.15)",
  eraseBtn:"#888",poweredBy:"#bbb",
};

// ─── STREAK ENGINE (localStorage-based behavior system) ───────────────────────
function getToday() { return new Date().toISOString().slice(0,10); }

function loadStreak() {
  try {
    const raw = localStorage.getItem("scalar-streak");
    if (!raw) return { count:0, lastCompleted:null, currentDay:1, hasCompletedToday:false, totalSessions:0 };
    return JSON.parse(raw);
  } catch { return { count:0, lastCompleted:null, currentDay:1, hasCompletedToday:false, totalSessions:0 }; }
}

function saveStreak(s) {
  try { localStorage.setItem("scalar-streak", JSON.stringify(s)); } catch {}
}

function computeStreak(s) {
  const today = getToday();
  const yesterday = new Date(Date.now()-86400000).toISOString().slice(0,10);
  if (!s.lastCompleted) return s;
  if (s.lastCompleted === today) return s; // already synced today
  if (s.lastCompleted === yesterday) return s; // streak intact, just not completed today yet
  // missed a day → reset
  return { ...s, count:0, hasCompletedToday:false };
}

function markDone(s) {
  const today = getToday();
  const yesterday = new Date(Date.now()-86400000).toISOString().slice(0,10);
  if (s.hasCompletedToday && s.lastCompleted === today) return s; // already done
  const newCount = s.lastCompleted === yesterday ? s.count + 1 : 1;
  return {
    ...s,
    count: newCount,
    lastCompleted: today,
...
// Fake social proof numbers — deterministic per user session
function getSocialProof() {
  try {
    let n = localStorage.getItem("scalar-sp");
    if (!n) { n = String(Math.floor(Math.random()*30)+110); localStorage.setItem("scalar-sp",n); }
    return Number(n);
  } catch { return 127; }
}
function getAheadPct() {
  try {
    let n = localStorage.getItem("scalar-ap");
    if (!n) { n = String(Math.floor(Math.random()*20)+22); localStorage.setItem("scalar-ap",n); }
    return Number(n);
  } catch { return 27; }
}
...
// ─── DATA ────────────────────────────────────────────────────────────────────
const TABS = [
  { id:"home",       label:"Home",        num:"00", icon:"⌂" },
...
function FakeProcessor({ onDone }) {
  const { T, theme } = useTheme();
  const isDark = theme === "dark";
  const lines = ["Analyzing your weak areas...","Comparing with toppers...","Building your study plan..."];
  const [step, setStep] = useState(0);
  const [barW, setBarW] = useState(0);

  useEffect(() => {
    const intervals = [0, 900, 1700];
    ...
    const bar = setInterval(() => {
      w += 4;
      setBarW(Math.min(w, 95));
      if (w >= 95) clearInterval(bar);
    }, 90);
    const done = setTimeout(() => { clearInterval(bar); setBarW(100); onDone && setTimeout(onDone, 300); }, 2800);
    return () => { timers.forEach(clearTimeout); clearTimeout(done); clearInterval(bar); };
  }, []);

  const accent = isDark ? "rgba(255,220,50,0.9)" : "#d09000";

  return (
    <div style={{padding:"28px 0 8px",display:"grid",gap:16}}>
        ...
        {lines.map((line, i) => (
          <div key={i} style={{
            ...
            <div style={{
              ...
              background: step > i ? accent : step === i ? "transparent" : T.outBdr,
              border: step > i ? "none" : `2px solid ${step===i?accent:T.outBdr}`,
              display:"flex",alignItems:"center",justifyContent:"center",
              transition:"all .3s",
            }}>
              {step > i && <span style={{fontSize:9,color:"#000",fontWeight:700}}>✓</span>}
              {step === i && <div style={{width:8,height:8,borderRadius:"50%",background:accent,animation:"pulse 1s ease infinite"}}/>}
            </div>
            <span style={{fontFamily:"'DM Mono',monospace",fontSize:12,color:step>=i?T.text:T.textFaint,letterSpacing:"0.06em"}}>{line}</span>
          </div>
        ))}
      </div>
      <div style={{background:T.outBdr,borderRadius:100,height:3,overflow:"hidden"}}>
        <div style={{height:"100%",background:accent,borderRadius:100,width:`${barW}%`,transition:"width .08s linear"}}/>
      </div>
    </div>
  );
}

// ─── STREAK BADGE (shown globally) ────────────────────────────────────────────
function StreakBadge({ streak, isDark }) {
  if (!streak || streak.count < 1) return null;
  const accent = isDark ? "rgba(255,200,80,0.9)" : "#d09000";
  const accentBg = isDark ? "rgba(255,200,50,0.1)" : "#fffbea";
  const accentBdr = isDark ? "rgba(255,200,50,0.25)" : "#f0d060";
  return (
    <div style={{
      ...
      <span style={{fontFamily:"'DM Mono',monospace",fontSize:10,color:accent,fontWeight:600,letterSpacing:"0.08em"}}>
...
// ─── DOPAMINE COMPLETION SCREEN ───────────────────────────────────────────────
function CompletionScreen({ streak, aheadPct, onContinue, isDark }) {
  const { T } = useTheme();
  const accent = isDark ? "rgba(255,220,50,0.9)" : "#d09000";
  const accentBg = isDark ? "rgba(255,220,50,0.08)" : "#fffbea";
  const greenBg = isDark ? "rgba(80,220,120,0.07)" : "#f0fff4";
  const greenColor = isDark ? "rgba(80,220,180,0.9)" : "#0d7040";
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background:greenBg,
        border:`1px solid ${isDark?"rgba(80,220,120,0.15)":"#80d0a0"}`,
        borderRadius:14,
      }}>
        <div style={{fontSize:42,marginBottom:12}}>🎉</div>
        <h3 style={{fontFamily:"'Cormorant Garamond',serif",fontWeight:700,fontSize:26,color:greenColor,letterSpacing:"-0.02em",marginBottom:6}}>
          Day {streak.currentDay - 1} Completed
        </h3>
        <div style={{
          display:"inline-flex",alignItems:"center",gap:6,
          background:isDark?"rgba(255,200,50,0.1)":"#fffbea",
          border:`1px solid ${isDark?"rgba(255,200,50,0.2)":"#f0d060"}`,
          borderRadius:100,padding:"6px 16px",marginTop:8,
        }}>
          <span style={{fontSize:14}}>🔥</span>
          <span style={{fontFamily:"'DM Mono',monospace",fontSize:11,color:accent,fontWeight:600,letterSpacing:"0.1em"}}>
            {streak.count} day{streak.count>1?"s":""} streak
          </span>
        </div>
      </div>
      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10}}>
        <div style={{padding:"16px",background:T.outBox,border:`1px solid ${T.outBdr}`,borderRadius:10,textAlign:"center"}}>
          <p style={{fontFamily:"'DM Mono',monospace",fontSize:18,fontWeight:700,color:accent,marginBottom:4}}>{aheadPct}%</p>
          <p style={{fontFamily:"'DM Sans',sans-serif",fontSize:11,color:T.textFaint,lineHeight:1.4}}>students ahead of</p>
        </div>
        <div style={{padding:"16px",background:T.outBox,border:`1px solid ${T.outBdr}`,borderRadius:10,textAlign:"center"}}>
          <p style={{fontFamily:"'DM Mono',monospace",fontSize:18,fontWeight:700,color:greenColor,marginBottom:4}}>{streak.totalSessions||1}</p>
          <p style={{fontFamily:"'DM Sans',sans-serif",fontSize:11,color:T.textFaint,lineHeight:1.4}}>total sessions</p>
        </div>
      </div>

      {/* Identity statement */}
      <div style={{
        background:isDark?"rgba(255,255,255,0.03)":"#f9f9fb",
        border:`1px solid ${T.cardBorder}`,borderRadius:10,
        padding:"14px 18px",textAlign:"center",
      }}>
        <p style={{fontFamily:"'DM Sans',sans-serif",fontSize:13,color:T.textSub,lineHeight:1.65}}>
          Only <strong style={{color:T.text}}>9% of students</strong> stay consistent this far.{" "}
          <span style={{color:accent,fontWeight:600}}>You're not average.</span>
        </p>
      </div>

      {/* Return CTA */}
      <div style={{
        background:isDark?"rgba(255,60,60,0.05)":"#fff5f5",
        border:`1px solid ${isDark?"rgba(255,80,80,0.15)":"#ffc5c5"}`,
        borderLeft:`3px solid ${isDark?"rgba(255,80,80,0.5)":"#ff6b6b"}`,
        borderRadius:"0 10px 10px 0",padding:"12px 16px",
      }}>
        <p style={{fontFamily:"'DM Mono',monospace",fontSize:11,color:isDark?"rgba(255,130,130,0.9)":"#c0392b",letterSpacing:"0.04em"}}>
          ⚠️ Come back tomorrow for Day {streak.currentDay}. Miss it → streak resets to 0.
        </p>
      </div>

      <button onClick={onContinue} style={{
        width:"100%",padding:"14px",borderRadius:10,
        border:`1px solid ${T.btnBdr}`,background:T.btnBg,color:T.btnTxt,
...
function StreakWarning({ streak, isDark }) {
  const { T } = useTheme();
  if (!streak || streak.count < 1 || streak.hasCompletedToday) return null;
  return (
    <div style={{
      background:isDark?"rgba(255,60,60,0.07)":"#fff5f5",
      border:`1px solid ${isDark?"rgba(255,80,80,0.18)":"#ffc5c5"}`,
      borderRadius:10,padding:"10px 16px",
      display:"flex",alignItems:"center",gap:10,
      marginBottom:16,animation:"fadeIn .3s ease both",
    }}>
      <span style={{fontSize:14,flexShrink:0}}>⚠️</span>
      <p style={{fontFamily:"'DM Mono',monospace",fontSize:11,color:isDark?"rgba(255,130,130,0.9)":"#c0392b",letterSpacing:"0.04em",lineHeight:1.5}}>
        You haven't completed today yet. Your {streak.count}-day streak is at risk.
      </p>
    </div>
  );
}
...
function renderAssignmentText(text, T) {
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    els.push(<p key={key++} style={{fontFamily:"'DM Sans',sans-serif",fontSize:14,color:T.textSub,lineHeight:1.8,marginBottom:6}}>{inlineBold(tr,T)}</p>);
  }
  return els;
}
    ...
    <div style={{marginTop:8}}>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14}}>
        <div style={{display:"flex",alignItems:"center",gap:8}}>
          ...
          <span style={{fontFamily:"'DM Mono',monospace",fontSize:10,color:T.textSub,letterSpacing:"0.15em",textTransform:"uppercase"}}>result</span>
        </div>
...
// ─── HOME TAB ────────────────────────────────────────────────────────────────
function HomeTab({ onNavigate, streak, onStreakUpdate }) {
  const { T, theme } = useTheme();
  const isDark = theme === "dark";
  const S = useS();
  ...
  const classOptions = [["11","Class 11"],["12","Class 12"],["dropper","Dropper"],["other","Other"]];
  const examOptions  = [["JEE","JEE"],["NEET","NEET"],["Boards","Boards"],["CA","CA Foundation"]];
  const subjectOpts  = [["Physics","Physics"],["Chemistry","Chemistry"],["Maths","Maths"],["Biology","Biology"],["English","English"],["Accounts","Accounts"]];

  const canGenerate = classVal && exam && weakSubject;
  const aheadPct = getAheadPct();
  const socialProof = getSocialProof();

  const accent = isDark ? "rgba(255,220,50,0.9)" : "#d09000";
  const accentBg = isDark ? "rgba(255,220,50,0.08)" : "#fffbea";
  const accentBdr = isDark ? "rgba(255,220,50,0.2)" : "#f0d060";

  const handleGenerate = async () => {
    if (!canGenerate) return;
    setProcessing(true); setProcessingDone(false); setPlan(""); setError("");
  };
  ...
  const handleProcessingDone = async () => {
    ...
    try {
      const result = await callGroq(
        "You are a JEE/NEET study coach. Create concise, actionable daily study plans. Be direct, specific, motivating. Use emojis sparingly. Format with clear sections.",
        `Create a 7-day daily study plan for a ${classVal} student preparing for ${exam}. Weakest subject: ${weakSubject}. Include: daily time blocks, specific topics, revision strategy, one key tip per day. Tight and actionable.`
      );
      setPlan(result);
  ...
  if (showDopamine) {
    return <CompletionScreen streak={streak} aheadPct={aheadPct} onContinue={()=>setShowDopamine(false)} isDark={isDark}/>;
  }

  return (
    <div style={{display:"grid",gap:0}}>

      {/* ── STREAK WARNING (shown if user has streak but hasn't completed today) */}
      <StreakWarning streak={streak} isDark={isDark}/>

      {/* ── HERO ── */}
      <div style={{padding:"24px 0 22px",borderBottom:`1px solid ${T.divider}`,marginBottom:24}}>

        {/* Badge: Used by serious students */}
        <div style={{
          display:"inline-flex",alignItems:"center",gap:7,
          background:accentBg,border:`1px solid ${accentBdr}`,
          borderRadius:100,padding:"5px 14px",marginBottom:16,
        }}>
          <div style={{width:6,height:6,borderRadius:"50%",background:accent,animation:"pulse 1.8s ease infinite"}}/>
          <span style={{fontFamily:"'DM Mono',monospace",fontSize:10,color:accent,letterSpacing:"0.15em",textTransform:"uppercase",fontWeight:600}}>
            Used by serious NEET &amp; JEE students
          </span>
        </div>
        ...
        <h2 style={{
          ...
          color:T.text,letterSpacing:"-0.02em",lineHeight:1.15,marginBottom:10,
        }}>
          You're already behind today.<br/>
          <span style={{color:accent}}>Fix your plan in 10 seconds.</span>
        </h2>

        <p style={{
          fontFamily:"'DM Sans',sans-serif",fontWeight:400,fontSize:14.5,
          color:T.textSub,lineHeight:1.65,maxWidth:460,
        }}>
          AI builds your daily study + revision plan automatically.{" "}
          <span style={{color:T.text,fontWeight:600}}>No login. No wait.</span>
        </p>

        {/* Social proof */}
        <p style={{
          fontFamily:"'DM Mono',monospace",fontSize:11,
          color:isDark?"rgba(255,220,50,0.5)":"#a07800",
          marginTop:10,letterSpacing:"0.04em",
        }}>
          {socialProof} students completed their plan today. Don't fall behind.
        </p>
      </div>

      {/* ── PROBLEM ── */}
      <div style={{
        background:isDark?"rgba(255,60,60,0.04)":"#fff5f5",
        border:`1px solid ${isDark?"rgba(255,60,60,0.12)":"#ffc5c5"}`,
        borderLeft:`3px solid ${isDark?"rgba(255,80,80,0.5)":"#ff6b6b"}`,
        borderRadius:"0 10px 10px 0",
        padding:"14px 18px",marginBottom:22,
      }}>
        <p style={{fontFamily:"'DM Sans',sans-serif",fontWeight:700,fontSize:12.5,color:isDark?"rgba(255,130,130,0.9)":"#c0392b",marginBottom:8,letterSpacing:"0.02em"}}>
          ⚡ Sound familiar?
        </p>
        {[
          "You study 5 hours but still forget everything by exam day",
          "No clear revision plan — just vibes and panic",
          "Inconsistent routine, skipping weak subjects",
        ].map((p,i)=>(
          <div key={i} style={{display:"flex",gap:10,marginBottom:i<2?7:0,alignItems:"flex-start"}}>
            <span style={{color:isDark?"rgba(255,100,100,0.6)":"#e55",fontSize:11,marginTop:2,flexShrink:0}}>✗</span>
            <span style={{fontFamily:"'DM Sans',sans-serif",fontSize:13,color:T.textSub,lineHeight:1.5}}>{p}</span>
          </div>
        ))}
      </div>
      ...
      <div style={{
        ...
        boxShadow:isDark?"0 8px 40px rgba(0,0,0,0.6), inset 0 1px 0 rgba(255,255,255,0.05)":"0 2px 16px rgba(0,0,0,0.06)",
        marginBottom:22,
      }}>
        <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:18}}>
          <div style={{width:6,height:6,borderRadius:"50%",background:accent}}/>
          <span style={{fontFamily:"'DM Mono',monospace",fontSize:10,color:T.textFaint,letterSpacing:"0.2em",textTransform:"uppercase"}}>generate my day {streak.currentDay} plan</span>
        </div>

        {!processing ? (
          <div style={{display:"grid",gap:16}}>
            <Field label="Select your level">
              <OptionGroup options={classOptions} value={classVal} onChange={setClassVal} wrap={true}/>
            </Field>
            <Field label="What are you preparing for?">
              <OptionGroup options={examOptions} value={exam} onChange={setExam} wrap={true}/>
            </Field>
            <Field label="Where are you struggling the most?">
              <OptionGroup options={subjectOpts} value={weakSubject} onChange={setWeakSubject} wrap={true}/>
            </Field>
            ...
            <button
              ...
              style={{
                ...S.btn,
                background:canGenerate?(isDark?"rgba(255,220,50,0.15)":accentBg):T.btnBg,
                border:`1px solid ${canGenerate?accentBdr:T.btnBdr}`,
                color:canGenerate?accent:T.btnTxt,
                fontSize:15,fontWeight:700,padding:"15px",transition:"all .2s",
              }}
            >
              👉 Fix My Plan Now
            </button>
          ...
          <div>
            {!processingDone && <FakeProcessor onDone={handleProcessingDone}/>}
            {loading && <Spinner/>}
            {error && <p style={S.err}>{error}</p>}
            {plan && (
              <div style={{animation:"fadeIn .3s ease both"}}>
                {/* Result header with streak warning */}
                <div style={{
                  background:accentBg,border:`1px solid ${accentBdr}`,
                  ...
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:10,flexWrap:"wrap"}}>
                    <div>
                      <p style={{fontFamily:"'DM Sans',sans-serif",fontWeight:700,fontSize:13,color:accent,marginBottom:2}}>
                        ✅ Your Day {streak.currentDay} Plan is Ready
                      </p>
                      <p style={{fontFamily:"'DM Mono',monospace",fontSize:11,color:isDark?"rgba(255,220,50,0.5)":"#a07800",letterSpacing:"0.03em"}}>
                        You're already ahead of {aheadPct}% students
                      </p>
                    </div>
                    <button onClick={handleMarkDone} style={{
                      padding:"8px 16px",borderRadius:8,border:`1px solid ${accentBdr}`,
                      background:accent,color:"#000",fontSize:12,fontFamily:"'DM Sans',sans-serif",
                      fontWeight:700,cursor:"pointer",flexShrink:0,letterSpacing:"0.02em",
                    }}>Mark Done ✓</button>
                  </div>
                  <div style={{
                    marginTop:10,padding:"8px 12px",
                    background:isDark?"rgba(255,60,60,0.08)":"#fff5f5",
                    border:`1px solid ${isDark?"rgba(255,80,80,0.15)":"#ffc5c5"}`,
                    borderRadius:7,
                  }}>
                    <p style={{fontFamily:"'DM Mono',monospace",fontSize:10.5,color:isDark?"rgba(255,130,130,0.9)":"#c0392b",letterSpacing:"0.04em"}}>
                      ⚠️ Miss today → your streak resets to 0. Come back tomorrow.
                    </p>
                  </div>
                </div>
                <ResultBox text={plan}/>
      ...
      <div style={{marginBottom:22}}>
        <p style={{fontFamily:"'DM Mono',monospace",fontSize:10,color:T.textFaint,letterSpacing:"0.2em",textTransform:"uppercase",marginBottom:12}}>how it works</p>
        <div style={{display:"grid",gap:8}}>
          {[
            ["01","Enter your exam + weak subject","5 seconds. No friction."],
            ["02","AI builds your daily plan","Personalized, not generic."],
            ["03","Follow it. Daily.","Consistency = rank improvement."],
          ].map(([num,title,sub])=>(
            <div key={num} style={{display:"flex",gap:14,alignItems:"flex-start",padding:"12px 14px",borderRadius:10,background:T.outBox,border:`1px solid ${T.outBdr}`}}>
              <span style={{fontFamily:"'DM Mono',monospace",fontSize:11,color:accent,letterSpacing:"0.1em",flexShrink:0,marginTop:1}}>{num}</span>
              <div>
                <p style={{fontFamily:"'DM Sans',sans-serif",fontWeight:700,fontSize:13.5,color:T.text,marginBottom:2}}>{title}</p>
                <p style={{fontFamily:"'DM Mono',monospace",fontSize:11,color:T.textFaint,letterSpacing:"0.04em"}}>{sub}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      {/* ── FEATURES ── */}
      <div style={{marginBottom:22}}>
        <p style={{fontFamily:"'DM Mono',monospace",fontSize:10,color:T.textFaint,letterSpacing:"0.2em",textTransform:"uppercase",marginBottom:12}}>everything you need to stop wasting time</p>
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8}}>
          {[
            {icon:"✦",label:"Write full assignments in seconds",tab:"assignment"},
            {icon:"◎",label:"Solve any question step-by-step",tab:"solver"},
            {icon:"▣",label:"Turn chapters into topper notes",tab:"summarizer"},
            {icon:"◈",label:"Practice real exam-level questions",tab:"exam"},
            {icon:"▤",label:"Study like rankers do",tab:"topper"},
            {icon:"▷",label:"Watch only what actually matters",tab:"youtube"},
          ].map(f=>(
            <button key={f.tab} onClick={()=>onNavigate(f.tab)} style={{
              display:"flex",flexDirection:"column",gap:5,
              padding:"13px 14px",borderRadius:10,border:`1px solid ${T.cardBorder}`,
              background:T.outBox,cursor:"pointer",textAlign:"left",transition:"all .15s",
            }}>
              <span style={{fontSize:13,color:T.textSub,fontFamily:"monospace"}}>{f.icon}</span>
              <span style={{fontFamily:"'DM Sans',sans-serif",fontSize:12,fontWeight:600,color:T.text,lineHeight:1.35}}>{f.label}</span>
            </button>
          ))}
        </div>
      </div>
      ...
      <div style={{
        ...
        <div>
          <p style={{fontFamily:"'DM Sans',sans-serif",fontWeight:700,fontSize:13,color:accent,marginBottom:3}}>
            Free access ends soon.
          </p>
          <p style={{fontFamily:"'DM Mono',monospace",fontSize:11,color:isDark?"rgba(255,220,50,0.5)":"#a07800",letterSpacing:"0.03em",lineHeight:1.5}}>
            Students using this daily are already ahead. If you delay → you fall behind.
          </p>
        </div>
      </div>
...
function AssignmentTab(){
  ...
  return(
    <div style={{display:"grid",gap:20}}>
      <Field label="What do you need to write? *"><input style={S.input} placeholder="e.g. Impact of Social Media on Mental Health" value={topic} onChange={e=>setTopic(e.target.value)}/></Field>
      <Field label="Subject (optional)"><input style={S.input} placeholder="e.g. Psychology" value={subject} onChange={e=>setSubject(e.target.value)}/></Field>
      <Field label="How detailed do you want it?">
      ...
      <button style={S.btn} onClick={run} disabled={loading||!topic.trim()}>{loading?"Writing like a topper...":"Write My Assignment Now"}</button>
...
function NoteBlock({block}){
  ...
  if(block.type==="heading") return(<div style={{marginBottom:6,marginTop:18,paddingBottom:8,borderBottom:`1px solid ${T.divider}`}}><span style={{fontFamily:"'Cormorant Garamond',serif",fontWeight:700,fontSize:20,color:T.text,letterSpacing:"-0.01em"}}><HighlightText text={block.content}/></span></div>);
  if(block.type==="subheading") return(<div style={{marginBottom:4,marginTop:14}}><span style={{fontFamily:"'DM Sans',sans-serif",fontWeight:700,fontSize:15,color:T.text,letterSpacing:"0.01em"}}><HighlightText text={block.content}/></span></div>);
  if(block.type==="bullet") return(<div style={{display:"flex",gap:10,marginBottom:6,paddingLeft:4,...base}}><span style={{color:T.textFaint,marginTop:2,flexShrink:0}}>◦</span><span><HighlightText text={block.content}/></span></div>);
  if(block.type==="callout") return(<div style={{margin:"14px 0",padding:"14px 18px",background:T.callBg,border:`1px solid ${T.callBdr}`,borderLeft:`3px solid ${T.callLeft}`,borderRadius:"0 10px 10px 0"}}><div style={{display:"flex",gap:8,alignItems:"flex-start"}}><span style={{fontSize:14,marginTop:1,flexShrink:0}}>⚡</span><span style={{...base,color:T.callTxt,fontWeight:500}}><HighlightText text={block.content}/></span></div></div>);
  if(block.type==="remember") return(<div style={{margin:"14px 0",padding:"14px 18px",background:T.remBg,border:`1px solid ${T.remBdr}`,borderLeft:`3px solid ${T.remLeft}`,borderRadius:"0 10px 10px 0"}}><div style={{display:"flex",gap:8,alignItems:"flex-start"}}><span style={{fontSize:14,marginTop:1,flexShrink:0}}>📌</span><span style={{...base,color:T.remTxt,fontWeight:500}}><HighlightText text={block.content}/></span></div></div>);
  if(block.type==="formula") return(<div style={{margin:"14px 0",padding:"16px 20px",background:T.fmlBg,border:`1px solid ${T.fmlBdr}`,borderRadius:10,textAlign:"center"}}><span style={{fontFamily:"'DM Mono',monospace",fontSize:15,color:T.fmlTxt,letterSpacing:"0.05em",fontWeight:600}}>{block.content}</span>{block.label&&<div style={{marginTop:6,fontFamily:"'DM Mono',monospace",fontSize:10,color:T.textFaint,letterSpacing:"0.1em"}}>{block.label}</div>}</div>);
  if(block.type==="flashcard") return(<div style={{margin:"8px 0",padding:"14px 18px",background:T.fcBg,border:`1px solid ${T.fcBdr}`,borderRadius:10}}><div style={{fontFamily:"'DM Mono',monospace",fontSize:10,color:T.fcQ,letterSpacing:"0.15em",marginBottom:6}}>Q</div><div style={{...base,color:T.fcQTxt,fontWeight:600,marginBottom:10}}><HighlightText text={block.question}/></div><div style={{fontFamily:"'DM Mono',monospace",fontSize:10,color:T.fcA,letterSpacing:"0.15em",marginBottom:6}}>A</div><div style={{...base,color:T.fcATxt}}><HighlightText text={block.answer}/></div></div>);
  if(block.type==="diagram") return(<div style={{margin:"18px 0",borderRadius:12,overflow:"hidden",border:`1px solid ${T.outBdr}`,background:T.outBox}}>{block.caption&&<div style={{padding:"8px 16px",borderBottom:`1px solid ${T.divider}`,fontFamily:"'DM Mono',monospace",fontSize:10,color:T.textFaint,letterSpacing:"0.1em"}}>{block.caption}</div>}<div style={{padding:"16px",display:"flex",justifyContent:"center"}} dangerouslySetInnerHTML={{__html:block.svg}}/></div>);
...
- {"type":"flashcard","question":"...","answer":"..."} — Q&A pair
- {"type":"diagram","svg":"<svg>...</svg>","caption":"..."} — SVG diagram
- {"type":"divider"} — section separator

Rules:
1. Be COMPREHENSIVE — cover every important concept
2. Use ==highlights== on critical terms
3. At least 2-3 formula blocks if topic has equations
4. At least 1 diagram SVG for visual topics
5. Mix callouts and remember blocks
6. End with 3-5 flashcard blocks
7. Add dividers between major sections
8. SVG: viewBox="0 0 500 200", white/light strokes, dark bg`;
  ...
  return(
    <div style={{marginTop:24}}>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14}}>
        <div style={{display:"flex",alignItems:"center",gap:8}}>
          <div style={{width:6,height:6,borderRadius:"50%",background:T.callLeft}}/>
          <span style={{fontFamily:"'DM Mono',monospace",fontSize:10,color:T.textSub,letterSpacing:"0.15em",textTransform:"uppercase"}}>Topper Notes</span>
        </div>
    ...
    <div style={{display:"grid",gap:20}}>
      <div style={{background:T.notesBg,border:`1px solid ${T.notesBdr}`,borderRadius:10,padding:"12px 16px"}}>
        <p style={{fontFamily:"'DM Mono',monospace",fontSize:11,color:T.notesTxt,lineHeight:1.7}}>
          ✦ &nbsp;Generates <strong style={{color:T.callLeft}}>highlights, formulas, diagrams, callouts & flashcards</strong> — not plain text.
        </p>
      </div>
      ...
      <button style={S.btn} onClick={run} disabled={loading||!text.trim()}>{loading?"Generating topper notes...":"Generate Rich Notes →"}</button>
      {error&&<p style={S.err}>{error}</p>}
      {loading&&<Spinner/>}
  ...
  return(
    <div style={{display:"grid",gap:20}}>
      <div style={{background:T.infoBg,border:`1px solid ${T.infoBdr}`,borderRadius:10,padding:"12px 16px"}}>
        <p style={{fontFamily:"'DM Mono',monospace",fontSize:11,color:T.infoTxt,lineHeight:1.7}}>✎ &nbsp;Sourced from SelfStudys, Vedantu, ICAI, JEEBooks & Scribd — curated from top rankers & board toppers.</p>
      </div>
...
function YoutubeTab(){
  ...
  return(
    <div style={{display:"grid",gap:20}}>
      <div style={{background:T.infoBg,border:`1px solid ${T.infoBdr}`,borderRadius:10,padding:"12px 16px"}}>
        <p style={{fontFamily:"'DM Mono',monospace",fontSize:11,color:T.infoTxt,lineHeight:1.7}}>▶ &nbsp;Handpicked from 50+ channels. #1 = best all-round. Expert / CA Pick = for specialised work. All free.</p>
      </div>
        ...
        {data?.channels.map((ch,i)=>(
          <a key={i} href={ch.url} target="_blank" rel="noopener noreferrer"
            ...
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:10,gap:12}}>
              ...
              <span style={{background:ch.badge==="#1"?T.ytBadge1Bg:"transparent",border:`1px solid ${ch.badge==="#1"?T.ytBadge1Bdr:T.ytBadgeXBdr}`,borderRadius:6,padding:"3px 10px",fontSize:11,fontFamily:"'DM Mono',monospace",color:ch.badge==="#1"?T.ytBadge1Txt:T.ytBadgeXTxt,flexShrink:0,whiteSpace:"nowrap"}}>{ch.badge}</span>
            </div>
...
export default function App(){
  ...
  // Re-check streak on mount (handles midnight rollover)
  useEffect(()=>{
    const refreshed = computeStreak(loadStreak());
    setStreak(refreshed);
    saveStreak(refreshed);
  },[]);
  ...
  const handleStreakUpdate = (updated) => setStreak(updated);

  const panels={
    home:<HomeTab onNavigate={setActive} streak={streak} onStreakUpdate={handleStreakUpdate}/>,
    ...
    <ThemeCtx.Provider value={{theme, T}}>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        input:focus,textarea:focus{border-color:${isDark?"rgba(255,255,255,0.3)":"#999"}!important;background:${isDark?"rgba(255,255,255,0.07)":"#fff"}!important;outline:none;box-shadow:0 0 0 3px ${isDark?"rgba(255,255,255,0.04)":"rgba(0,0,0,0.06)"};}
        ...
        ${isDark?`
        @keyframes tubeOn{0%{opacity:0;text-shadow:none;}5%{opacity:0.9;text-shadow:0 0 40px rgba(255,255,255,0.9),0 0 80px rgba(255,255,255,0.5),0 0 120px rgba(255,255,255,0.25);}6%{opacity:0.1;}7%{opacity:0.95;text-shadow:0 0 40px rgba(255,255,255,0.9),0 0 80px rgba(255,255,255,0.5);}8%{opacity:0.2;}10%{opacity:1;text-shadow:0 0 40px rgba(255,255,255,0.9),0 0 80px rgba(255,255,255,0.5),0 0 120px rgba(255,255,255,0.25);}15%{opacity:0.4;}16%{opacity:1;text-shadow:0 0 40px rgba(255,255,255,0.9),0 0 80px rgba(255,255,255,0.5);}25%{opacity:0.8;}26%{opacity:1;text-shadow:0 0 50px rgba(255,255,255,1),0 0 100px rgba(255,255,255,0.6),0 0 160px rgba(255,255,255,0.3);}100%{opacity:1;text-shadow:0 0 30px rgba(255,255,255,0.65),0 0 60px rgba(255,255,255,0.35),0 0 100px rgba(255,255,255,0.18);}}
        @keyframes tubeIdle{0%,100%{text-shadow:0 0 30px rgba(255,255,255,0.65),0 0 60px rgba(255,255,255,0.35),0 0 100px rgba(255,255,255,0.18);}48%{text-shadow:0 0 30px rgba(255,255,255,0.65),0 0 60px rgba(255,255,255,0.35),0 0 100px rgba(255,255,255,0.18);}49%{text-shadow:0 0 10px rgba(255,255,255,0.18),0 0 20px rgba(140,180,255,0.2);}50%{text-shadow:0 0 30px rgba(255,255,255,0.65),0 0 60px rgba(255,255,255,0.35),0 0 100px rgba(255,255,255,0.18);}92%{text-shadow:0 0 30px rgba(255,255,255,0.65),0 0 60px rgba(255,255,255,0.35);}93%{text-shadow:0 0 5px rgba(255,255,255,0.12);}94%{text-shadow:0 0 30px rgba(255,255,255,0.65),0 0 60px rgba(255,255,255,0.35),0 0 100px rgba(255,255,255,0.18);}}
        @keyframes glowPulse{0%,100%{opacity:0.7;transform:translateX(-50%) scaleX(1);}48%{opacity:0.7;}49%{opacity:0.2;}50%{opacity:0.7;}92%{opacity:0.7;}93%{opacity:0.1;}94%{opacity:0.7;}}
        @keyframes bgFlicker{0%,100%{opacity:1;}49%{opacity:1;}49.5%{opacity:0.6;}50%{opacity:1;}92.5%{opacity:1;}93%{opacity:0.7;}93.5%{opacity:1;}}
        @keyframes grainShift{0%{transform:translate(0,0)}10%{transform:translate(-2%,-3%)}20%{transform:translate(3%,2%)}30%{transform:translate(-1%,4%)}40%{transform:translate(2%,-2%)}50%{transform:translate(-3%,1%)}60%{transform:translate(1%,3%)}70%{transform:translate(-2%,-1%)}80%{transform:translate(3%,2%)}90%{transform:translate(-1%,-3%)}100%{transform:translate(0,0)}}
        @keyframes scanMove{0%{transform:translateY(-100%)}100%{transform:translateY(100vh)}}
        .tube-on{animation:tubeOn 1.8s ease forwards;}.tube-idle{animation:tubeIdle 7s ease-in-out infinite;}
        .grain-layer{position:fixed;inset:-50%;width:200%;height:200%;pointer-events:none;z-index:3;opacity:0.045;background-image:url("data:image/svg+xml,%3Csvg viewBox='0 0 512 512' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='g'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.72' numOctaves='4' stitchTiles='stitch'/%3E%3CfeColorMatrix type='saturate' values='0'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23g)'/%3E%3C/svg%3E");background-size:220px 220px;animation:grainShift 0.1s steps(1) infinite;mix-blend-mode:screen;}
      ...
      {isDark&&<>
        ...
        <div className="grain-layer"/><div className="scanlines"/><div className="vignette"/>
      ...
      <div style={{position:"relative",zIndex:5,minHeight:"100vh",display:"flex",flexDirection:"column",alignItems:"center",padding:"48px 16px 140px",opacity:mounted?1:0,transition:"opacity .4s ease"}}>

        {/* ── GLOBAL WARNING BANNER (sticky message) ── */}
        <div style={{width:"100%",maxWidth:680,marginBottom:16}}>
          <div style={{
            background:isDark?"rgba(255,220,50,0.05)":"#fffbea",
            border:`1px solid ${isDark?"rgba(255,220,50,0.15)":"#f0d060"}`,
            borderRadius:8,padding:"8px 16px",
            display:"flex",alignItems:"center",gap:10,
          }}>
            <span style={{fontSize:12,flexShrink:0}}>⚡</span>
            <p style={{fontFamily:"'DM Mono',monospace",fontSize:10.5,color:isDark?"rgba(255,220,50,0.7)":"#a07800",letterSpacing:"0.04em",lineHeight:1.4}}>
              You either follow the plan… or fall behind others.
            </p>
            {streak.count > 0 && (
        ...
        <div style={{marginBottom:40,width:"100%",maxWidth:680}}>
          <div style={{position:"relative",display:"flex",justifyContent:"center",alignItems:"center",marginBottom:22}}>
            <div style={{display:"inline-flex",alignItems:"center",gap:8,border:`1px solid ${T.cardBorder}`,borderRadius:100,padding:"6px 18px 6px 12px",background:T.inputBg}}>
              <div style={{width:6,height:6,borderRadius:"50%",background:T.badgeDot,animation:isDark?"pulse 2.5s ease infinite":"none"}}/>
              <span style={{fontFamily:"'DM Mono',monospace",fontSize:10,color:T.badgeTxt,letterSpacing:"0.22em",textTransform:"uppercase"}}>Used by serious NEET &amp; JEE students</span>
            </div>
            <button onClick={()=>setTheme(isDark?"light":"dark")} style={{position:"absolute",right:0,top:"50%",transform:"translateY(-50%)",display:"flex",alignItems:"center",gap:6,padding:"6px 12px 6px 9px",borderRadius:100,border:`1px solid ${isDark?"rgba(255,255,255,0.15)":"#d0d0d8"}`,background:isDark?"rgba(255,255,255,0.07)":"#fff",cursor:"pointer",boxShadow:isDark?"none":"0 1px 6px rgba(0,0,0,0.08)",whiteSpace:"nowrap"}}>
              <span style={{fontSize:14,lineHeight:1}}>{isDark?"☀️":"🌙"}</span>
              <span style={{fontFamily:"'DM Mono',monospace",fontSize:9,letterSpacing:"0.1em",color:isDark?"rgba(255,255,255,0.65)":"#555",fontWeight:500,textTransform:"uppercase"}}>{isDark?"Light":"Dark"}</span>
            </button>
          </div>
          ...
          <div style={{textAlign:"center"}}>
            <div style={{position:"relative",display:"inline-block"}}>
              ...
              <h1 className={isDark&&mounted?"tube-on tube-idle":""} style={{fontFamily:"'Cormorant Garamond',serif",fontWeight:700,fontSize:"clamp(56px,11vw,96px)",color:T.text,letterSpacing:"-0.03em",lineHeight:1}}>Scalar</h1>
            ...
            <p style={{marginTop:20,fontFamily:"'DM Sans',sans-serif",fontWeight:400,fontSize:15,color:T.tagline,letterSpacing:"0.01em",lineHeight:1.6}}>
              Study 2× faster using AI.{" "}
              <span style={{color:T.textSub,fontWeight:600}}>Get your daily plan in 10 seconds.</span>
            </p>

            <button onClick={()=>setActive("home")} style={{
              marginTop:18,display:"inline-flex",alignItems:"center",gap:8,
              padding:"11px 26px",borderRadius:100,cursor:"pointer",
              fontFamily:"'DM Sans',sans-serif",fontWeight:700,fontSize:14,
              background:isDark?"rgba(255,220,50,0.12)":"#fffbea",
              border:`1px solid ${isDark?"rgba(255,220,50,0.25)":"#f0d060"}`,
              color:isDark?"rgba(255,220,50,0.9)":"#d09000",
        ...
        {/* CARD */}
        <div style={{background:T.card,width:"100%",maxWidth:680,borderRadius:16,padding:"26px 26px 32px",border:`1px solid ${T.cardBorder}`,boxShadow:isDark?"0 32px 80px rgba(0,0,0,0.8), inset 0 1px 0 rgba(255,255,255,0.06)":"0 4px 24px rgba(0,0,0,0.07)"}}>
          <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:24,paddingBottom:18,borderBottom:`1px solid ${T.headerBdr}`}}>
            ...
            {/* Streak in card header for non-home tabs */}
            {active !== "home" && streak.count > 0 && (
      ...
      {/* BOTTOM NAV */}
      <nav style={{position:"fixed",bottom:0,left:0,right:0,zIndex:50,background:T.nav,borderTop:`1px solid ${T.navBorder}`,display:"flex",justifyContent:"space-around",alignItems:"stretch",boxShadow:isDark?"0 -20px 60px rgba(0,0,0,0.7)":"0 -2px 12px rgba(0,0,0,0.06)",paddingBottom:"env(safe-area-inset-bottom,0px)",overflowX:"auto"}}>
        {TABS.map(tab=>{
          const on=active===tab.id;
          return(
            <button key={tab.id} onClick={()=>setActive(tab.id)} style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:7,padding:"16px 4px 18px",border:"none",background:"transparent",cursor:"pointer",position:"relative",minWidth:0}}>
              <div style={{position:"absolute",top:0,left:"50%",transform:"translateX(-50%)",height:2,borderRadius:"0 0 4px 4px",width:on?32:0,background:T.navIconOn,transition:"width .25s cubic-bezier(.4,0,.2,1)"}}/>
              <div style={{width:46,height:46,borderRadius:14,display:"flex",alignItems:"center",justifyContent:"center",background:on?T.navBubbleOn:"transparent",border:`1px solid ${on?T.navBubbleBdrOn:T.navBorder}`,transition:"all .2s",position:"relative"}}>
                ...
                {tab.id==="home" && streak.count>0 && !streak.hasCompletedToday && (
                  <div style={{position:"absolute",top:4,right:4,width:7,height:7,borderRadius:"50%",background:"#ff4444",border:`1px solid ${T.nav}`}}/>
                )}
              </div>
              <span style={{fontFamily:"'DM Mono',monospace",fontSize:9,letterSpacing:"0.06em",whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis",maxWidth:"90%",color:on?T.navLblOn:T.navLblOff,fontWeight:on?500:400,transition:"color .2s",textTransform:"uppercase"}}>{tab.label}</span>
            </button>
          );
        })}
      </nav>
