  ...
  const generatePlan = async () => {
    ...
    try {
      const result = await callGroq(
        "You are a JEE/NEET study coach. Create concise, actionable daily study plans. Be direct, specific, and motivating. Use emojis sparingly. Format with clear sections.",
        `Create a 7-day daily study plan for a ${classVal} student preparing for ${exam}. Their weakest subject is ${weakSubject}. Include: daily time allocation, specific topics to cover, revision strategy, and one key tip. Keep it tight and actionable.`
      );
      setPlan(result);
      setGenerated(true);
    ...
    <div style={{display:"grid",gap:0}}>
      ...
      <div style={{
        ...
        <h2 style={{
          ...
          color:T.text,letterSpacing:"-0.02em",lineHeight:1.15,marginBottom:12,
        }}>
          Stop wasting time studying.<br/>
          <span style={{color:accent}}>Let AI plan your day.</span>
        </h2>

        <p style={{
          fontFamily:"'DM Sans',sans-serif",fontWeight:400,fontSize:15,
          color:T.textSub,lineHeight:1.65,marginBottom:0,
          maxWidth:460,
        }}>
          Personalized revision + study plan in seconds.{" "}
          <span style={{color:T.text,fontWeight:600}}>No login. No wait. Just results.</span>
        </p>
      </div>
      ...
      <div style={{
        ...
        <p style={{fontFamily:"'DM Sans',sans-serif",fontWeight:700,fontSize:13,color:isDark?"rgba(255,130,130,0.9)":"#c0392b",marginBottom:10,letterSpacing:"0.02em"}}>
          ⚡ Sound familiar?
        </p>
        {["You study hard but still forget everything by exam day","No clear revision plan — just vibes and panic","Inconsistent routine, skipping weak subjects"].map((p,i)=>(
          <div key={i} style={{display:"flex",gap:10,marginBottom:i<2?8:0,alignItems:"flex-start"}}>
            ...
            <span style={{fontFamily:"'DM Sans',sans-serif",fontSize:13.5,color:T.textSub,lineHeight:1.5}}>{p}</span>
          </div>
        ))}
      </div>
      ...
      <div style={{
        ...
        <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:20}}>
          ...
          <span style={{fontFamily:"'DM Mono',monospace",fontSize:10,color:T.textFaint,letterSpacing:"0.2em",textTransform:"uppercase"}}>get your daily plan — 10 seconds</span>
        </div>
        ...
        <div style={{display:"grid",gap:18}}>
          ...
          <button
            ...
            style={{
              ...
              background: canGenerate
                ? (isDark?"rgba(255,220,50,0.15)":accentBg)
                : T.btnBg,
          ...
          {loading && <Spinner/>}
          {plan && <ResultBox text={plan}/>}
        </div>
      </div>

      {/* ── HOW IT WORKS ─────────────────────────────────────── */}
      <div style={{marginBottom:24}}>
        <p style={{fontFamily:"'DM Mono',monospace",fontSize:10,color:T.textFaint,letterSpacing:"0.2em",textTransform:"uppercase",marginBottom:14}}>how it works</p>
        <div style={{display:"grid",gap:10}}>
          {[
            ["01","Enter your exam + weak subject","Takes 5 seconds"],
            ["02","AI builds your daily plan","Personalized, not generic"],
            ["03","Follow it. Daily.","Track progress, fix weak areas"],
          ].map(([num,title,sub])=>(
            <div key={num} style={{
              display:"flex",gap:14,alignItems:"flex-start",
              padding:"14px 16px",borderRadius:10,
              background:T.outBox,border:`1px solid ${T.outBdr}`,
            }}>
              <span style={{fontFamily:"'DM Mono',monospace",fontSize:11,color:accent,letterSpacing:"0.1em",flexShrink:0,marginTop:1}}>{num}</span>
              <div>
                <p style={{fontFamily:"'DM Sans',sans-serif",fontWeight:700,fontSize:14,color:T.text,marginBottom:2}}>{title}</p>
      ...
      <div style={{marginBottom:24}}>
        <p style={{fontFamily:"'DM Mono',monospace",fontSize:10,color:T.textFaint,letterSpacing:"0.2em",textTransform:"uppercase",marginBottom:14}}>what scalar does</p>
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10}}>
          {[
            {icon:"✦",label:"Assignment Writer",tab:"assignment"},
            {icon:"◎",label:"Step-by-Step Solver",tab:"solver"},
            {icon:"▣",label:"Rich Study Notes",tab:"summarizer"},
            {icon:"◈",label:"Exam Questions",tab:"exam"},
            {icon:"▤",label:"Topper Notes",tab:"topper"},
            {icon:"▷",label:"Free Classes",tab:"youtube"},
          ].map(f=>(
            <button key={f.tab} onClick={()=>onNavigate(f.tab)} style={{
              display:"flex",flexDirection:"column",gap:6,
              padding:"14px 16px",borderRadius:10,border:`1px solid ${T.cardBorder}`,
              background:T.outBox,cursor:"pointer",textAlign:"left",
              transition:"all .15s",
            }}>
              <span style={{fontSize:14,color:T.textSub,fontFamily:"monospace"}}>{f.icon}</span>
              <span style={{fontFamily:"'DM Sans',sans-serif",fontSize:12.5,fontWeight:600,color:T.text,lineHeight:1.3}}>{f.label}</span>
            </button>
          ))}
        </div>
      </div>
      ...
      <div style={{
        ...
        <div>
          <p style={{fontFamily:"'DM Sans',sans-serif",fontWeight:700,fontSize:13.5,color:accent,marginBottom:3}}>
            Free for early users. Will be paid soon.
          </p>
          <p style={{fontFamily:"'DM Mono',monospace",fontSize:11,color:isDark?"rgba(255,220,50,0.5)":"#a07800",letterSpacing:"0.03em"}}>
            Used daily by serious JEE &amp; NEET students.
          </p>
        </div>
      </div>
...
export default function App(){
  ...
  const panels={
    home:<HomeTab onNavigate={setActive}/>,
      ...
      <div style={{
        ...
        <div style={{marginBottom:40,width:"100%",maxWidth:680}}>
          <div style={{position:"relative",display:"flex",justifyContent:"center",alignItems:"center",marginBottom:22}}>
            ...
            <button
              ...
              style={{
                ...
                padding:"6px 12px 6px 9px",borderRadius:100,
          ...
          <div style={{textAlign:"center"}}>
            ...
            {/* NEW: Conversion-first sub + CTA instead of generic tagline */}
