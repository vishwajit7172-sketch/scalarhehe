    ...
    <ThemeCtx.Provider value={{theme, T}}>
      ...
      <div style={{
        ...
        <div style={{marginBottom:40,width:"100%",maxWidth:680}}>
          ...
          {/* Top row: badge centered, toggle pinned right — all within the 680px column */}
          <div style={{position:"relative",display:"flex",justifyContent:"center",alignItems:"center",marginBottom:22}}>
            ...
            {/* Toggle sits at the right edge of this row, never floating outside */}
            <button
          ...
          {/* Logo — fully centered, no inline-block shifting */}
